...
int gameLoop(void){
  ...
  //Ilhas
  BITMAP *ilhaInferior = load_bitmap("imagens/estaticos/ilhas/539.png",NULL);
  ...
  while (!key[KEY_ESC]){
    ...
    draw_trans_sprite(buffer,gradeTabuleiro,0,432);
    draw_trans_sprite(buffer,ilhaInferior,0,432);
